...
/// Reset vector. boot1 jumps here (via the jump instruction that `xous-sign-image`
/// plants in the first word of the signature block).
...
/// Trap handler of last resort: spew 'u' out the debug UART and spin.
#[link_section = ".text.init"]
#[export_name = "abort"]
pub extern "C" fn abort() -> ! {
    unsafe {
        ...
        "11:",
            ...
            "li          t3, 4000",
            // add a short delay between characters to help differentiate them on a scope
        "12:",
            "addi        t3, t3, -1",
            "bne         x0, t3, 12b",
